    ...
    <Panel header={blockHeader} style={{ padding: 10 }} {...props}>
      <PanelBody title={colorSchemeLabel}>
        <PanelRow className="stb-select-row">
          <Flex>
            <FlexItem isBlock>
              <SelectControl className="stb-block-style-select stb-input-100" value={styleId} options={styleList} onChange={onChange('styleId')} />
            </FlexItem>
          </Flex>
        </PanelRow>
      </PanelBody>
      <PanelBody title={captionLabel}>
        ...
        <PanelRow>
          <CheckboxControl checked={defaultCaption} label={defaultCaptionLabel} onChange={onChange('defaultCaption')} />
        </PanelRow>
      </PanelBody>
      <PanelBody title={contentLabel}>
        <PanelRow>
          <RichText className="stb-input-100" value={content} onChange={onChange('content')} tagName="p" />
        </PanelRow>
      </PanelBody>
      ...
      <PanelBody title={appearanceLabel} initialOpen={false}>
        <PanelRow>
          <Flex gap={3}>
            <FlexItem>
              <CheckboxControl checked={collapsing} label={collapsingLabel} onChange={onChange('collapsing')} />
            </FlexItem>
            <FlexItem>
              <CheckboxControl checked={collapsed} label={collapsedLabel} onChange={onChange('collapsed')} />
            </FlexItem>
          </Flex>
        </PanelRow>
      </PanelBody>
      <PanelBody title={marginsLabel} initialOpen={false}>
        <PanelRow>
          <Flex gap={3}>
            ...
            <FlexItem>
              <TextControl value={marginRight} label={marginRightLabel} onChange={onChange('marginRight')} />
            </FlexItem>
            <FlexItem>
              <TextControl value={marginBottom} label={marginBottomLabel} onChange={onChange('marginBottom')} />
            </FlexItem>
            <FlexItem>
